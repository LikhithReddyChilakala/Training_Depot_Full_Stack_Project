...
<title>Record Not Found &middot; Training Depot</title>
...
<body>
  <main class="page-shell section" style="text-align:center; padding-top: var(--space-8);">
    <span class="eyebrow">404 &middot; NOT ON THE FLOOR</span>
    <h1>Record Not Found</h1>
    <p style="margin: 0 auto var(--space-5); max-width:46ch;">
      <c:out value="${message}" default="That equipment record, order, or page doesn't exist." />
    </p>
